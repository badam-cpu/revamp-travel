      ...
      <main>
        <section className="border-b border-basalt/10 bg-chalk">
          <div className="container grid items-center gap-8 py-14 lg:grid-cols-[1.4fr_0.6fr] lg:py-20">
            ...
            {/* Open hand (rotated horizontal) offering a heart floating above with a
                gap — composed from lucide's hand + heart paths, in brand apricot. */}
            <div className="relative hidden h-56 w-56 justify-self-end lg:block xl:h-64 xl:w-64" aria-hidden="true">
              <svg
                viewBox="0 0 24 24"
                className="absolute left-1/2 top-0 h-20 w-20 -translate-x-1/2 text-apricot/85 xl:h-24 xl:w-24"
                fill="currentColor"
                fillOpacity={0.14}
                stroke="currentColor"
                strokeWidth={1.3}
              ...
              <svg
                viewBox="0 0 24 24"
                className="absolute bottom-0 left-1/2 h-44 w-44 text-apricot/85 xl:h-52 xl:w-52"
                fill="none"
                stroke="currentColor"
                strokeWidth={1.3}
                strokeLinecap="round"
